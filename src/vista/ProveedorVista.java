...
public class ProveedorVista extends JFrame {
    ...
    public JButton btnRegistrar, btnActualizar, btnEliminar, btnVolver, btnBuscar;
    ...
    public ProveedorVista() {
        ...
        lblTitulo.setBounds(280, 20, 400, 30);
        panel.add(lblTitulo);
        ...
        btnRegistrar.setBounds(400, 160, 100, 30);
        panel.add(btnRegistrar);

        btnActualizar = new JButton("Modificar");
        btnActualizar.setBounds(510, 160, 100, 30);
        panel.add(btnActualizar);

        btnEliminar = new JButton("Eliminar");
        btnEliminar.setBounds(620, 160, 100, 30);
